...
module.exports.addServiceSubCategory = (async (req, res) => {
	try {
		...
		/*  #swagger.parameters['obj'] = {
                    in: 'body',
                    description: "service details for add - en_name, ar_name, isActive, description",
                    schema: { $serviceId: "", $en_name: "", $ar_name: "", $isActive: "", $description: ""}
            } */
...
module.exports.subCategoryUpdate = async (req, res) => {
	...
	/*  #swagger.parameters['obj'] = {
                            ...
                            schema: { $serviceId: "", $id: "", $en_name: "", $ar_name: "", $isActive: "", $description: ""}
                    } */
	try {
