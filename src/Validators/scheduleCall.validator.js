...
const addScheduleCallValidator = [
	body('queryId')
		.isLength({min: 1})
		.trim()
	...
	body('time')
     ...
     body('scheduleAt')
		.isLength({min: 1})
		.trim()
		.withMessage('scheduleAt must be specified.'),
...
const scheduleCallValidator = {
	addScheduleCallValidator: addScheduleCallValidator,

};

module.exports = scheduleCallValidator;
