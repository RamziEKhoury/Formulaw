...
module.exports = function (app) {
  ...
  app.get("/api/v1/auth/admins", userController.admins);
  app.get("/api/v1/auth/admin/:id", userController.admin);

  app.put("/api/v1/auth/admin/:id", userController.updateprofile);

  app.delete("/api/v1/auth/delete-user", userController.deleteUser);
};
